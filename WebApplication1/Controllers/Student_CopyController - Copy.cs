...
namespace WebApplication1.Controllers
{
    ...
    public class Student_CopyController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Student_Copy/newstu")] //adding student with dto entirely from the body
        ...
        [HttpPost]
        [Route("api/Student_Copy/new/{id}")] // adding student with name from the body, id from the url
        ...
        [HttpPost]
        [Route("api/Student_Copy/{id}/{name}")] // adding student with params from the url
        ...
        [HttpDelete]
        [Route("api/Student_Copy/delete/{id}")] 
